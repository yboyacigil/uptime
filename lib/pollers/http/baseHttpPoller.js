...
BaseHttpPoller.prototype.onResponseCallback = function(res) {
  ...
  if (statusCode.match(/4\d{2}/)) {
    return this.handleClientErrorResponse(res);
  }
...
BaseHttpPoller.prototype.handleClientErrorResponse = function(res) {
  var poller = this;
  var body = '';
  this.debug(this.getTime() + "ms - Status code 4XX client error");
